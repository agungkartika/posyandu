    ...
    <div class="left_col scroll-view">
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
                <h3>Layanan</h3>
                <ul class="nav side-menu">
                    <li><a href="<?= base_url('imunisasi-anak/imunisasi') ?>"><i class="fa fa-plus-square"></i> Imunisasi Anak</a>
                    </li>
                </ul>
                <ul class="nav side-menu">
                    <li><a href="<?= base_url('imunisasi-anak/data-imunisasi') ?>"><i class="fa fa-list"></i> Data Imunisasi</a>
                    </li>
                </ul>
            </div>
        </div>
