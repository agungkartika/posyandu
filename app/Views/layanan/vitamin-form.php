  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 ">
      <div class="x_panel">
        <div class="x_content">
          <br />
          <form id="vitamin-form" name="vitamin-form" class="form-horizontal form-label-left"
                action="<?php echo base_url('vitamin-anak/submit'); ?>" method="POST">
            <!-- Nama Anak -->
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6 col-sm-6">
                <input class="date-picker form-control" name="tanggal_pemberian" id="tanggal_pemberian" type="text"
          ...
          <!-- jQuery & DataTables initialization + Event Delegation -->
